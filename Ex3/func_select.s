...
.L33:   			# options 32-33
    ...
    leaq    1(%rax),	%r12	# saves the result in %r12
    ...
    xorq    %rax,   	%rax	# zeros %rax
    call    replaceChar	# calls the relevant function
    leaq    1(%rax),	%r13 	# saves the result in %r13
